    ...
    AppBar(
      ...
      title: Row(
        children: [
          ...
          IconButton(icon: Icon(Icons.settings, color: darke), onPressed: () {}),
          Stack(
            children: [
              IconButton(icon: Icon(Icons.notifications, color: darke.withOpacity(.7),), onPressed: () {}),
              Positioned(
                top: 7,
                right: 7,
                child: Container(
          ...
          CustomText(text: "Andrew Lee", color: lightGrey,),
